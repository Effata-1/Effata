...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { id: 'coaching',       label: 'Coaching Messages',    route: '/genai-controls/coaching-messages', legacyRoutes: ['/policies/coaching-templates'], step: 5 },
      { id: 'netskope-pack',  label: 'Netskope Policy Pack', route: '/genai-controls/netskope-pack',      legacyRoutes: ['/genai-controls/vendor-mapping/netskope/recommendation'], step: 6, badge: 'deliverable' },
      { id: 'executive-report',     label: 'Executive Report',    route: '/genai-controls/executive-report', legacyRoutes: ['/genai-controls/presentation'],                           step: 7, badge: 'deliverable' },
    ],
  },
  {
    id:    'foundation',
    label: 'Foundation',
    pages: [
      { id: 'data-catalog',       label: 'Data Catalog',       route: '/foundation/data-catalog',       legacyRoutes: ['/policies/data-catalog']       },
      { id: 'labels',             label: 'Labels',             route: '/foundation/labels',             legacyRoutes: ['/policies/classifications']    },
      ...
      { id: 'identity',  label: 'Identity Context', route: '/foundation/identity', legacyRoutes: ['/policies/identity'] },
      { id: 'channels',  label: 'Channels',         route: '/foundation/channels', legacyRoutes: ['/policies/channels'] },
    ],
  },
  {
    id:    'test-evidence',
  ...
  },
  {
    ...
    pages: [
      ...
      { id: 'regulations',         label: 'Regulations & Frameworks', route: '/compliance/regulations' },
      { id: 'gap-report',          label: 'Gap Report',               route: '/compliance/gap-report' },
      { id: 'audit-trail',         label: 'Audit Trail',              route: '/compliance/audit-trail' },
    ],
  },
  {
    id:    'settings',
    ...
    pages: [
      ...
      { id: 'admin-audit-log',    label: 'Audit Log',    route: '/settings/admin/audit-log',    minRole: 'admin' },
      { id: 'admin-refresh-logs', label: 'Refresh Logs', route: '/settings/admin/refresh-logs', minRole: 'admin' },
      { id: 'admin-cron-runs',    label: 'Cron Runs',    route: '/settings/admin/cron-runs',    minRole: 'admin' },
      { id: 'admin-ai-logs',      label: 'AI Logs',      route: '/settings/admin/ai-logs',      minRole: 'admin' },
    ],
  },
]

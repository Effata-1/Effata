...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { id: 'netskope-policy-pack', label: 'Netskope Policy Pack', route: '/genai-controls/netskope-pack',      legacyRoutes: ['/genai-controls/vendor-mapping/netskope/recommendation'], step: 6, badge: 'deliverable' },

...
// These 10 families are the canonical risk classification taxonomy across the product.
...
export const RISK_FAMILIES = [
  ...
  { id: 'business_operations_internal_data', label: 'Business Operations & Internal Data', color: 'blue',   order: 9  },
  { id: 'public_low_risk_data',              label: 'Public & Low-Risk Data',               color: 'green',  order: 10 },
] as const

  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-xl font-bold text-white">GenAI Apps</h1>
        ...
        {appsWithScores.map(({ app, score, classification }) => {
          ...
          return (
            <Link
              ...
              className="group block rounded-xl border border-zinc-800 bg-zinc-900/50 p-4 hover:border-zinc-600 hover:bg-zinc-900 transition-all"
            >
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-white group-hover:text-blue-300 transition-colors truncate">{app.app_name}</p>
                  <p className="text-xs text-zinc-500 truncate">{app.vendor} · {app.app_type}</p>
                </div>
              ...
              <div className="flex items-center justify-between mb-3">
                <div>
                  <p className="text-[10px] text-zinc-600 uppercase tracking-wide mb-0.5">Trust Score</p>
                  {score ? (
                    <div className={cn(
                ...
                <div className="text-right">
                  <p className="text-[10px] text-zinc-600 uppercase tracking-wide mb-0.5">DLP Activities</p>
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] text-zinc-600">System suggests:</span>
                  <span className="text-[10px] text-zinc-400 font-medium">{suggested}</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] text-zinc-600">Your classification:</span>
                  {cls !== 'unknown' ? (
                    <span className={cn(

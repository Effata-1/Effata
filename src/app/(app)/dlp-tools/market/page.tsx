...
import { listCustomTools } from './actions'
import { MarketExplorer } from './_components/market-explorer'

export default async function MarketPage() {
  await requireRole('analyst')
  const [{ data: profile }, customTools] = await Promise.all([
  ...
  return (
    <div className="space-y-8">
      ...
      <MarketExplorer tools={tools} orgTools={orgTools} customTools={customTools} />
    </div>
  )
}

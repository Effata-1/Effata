...
export default async function TestDataPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white mb-1">Test Data</h1>
      ...
      <Suspense fallback={<div className="text-sm text-zinc-600 italic">Loading test data generator...</div>}>

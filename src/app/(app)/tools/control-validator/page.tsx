...
export default async function DlpTestPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white mb-1">Control Validator</h1>
      ...
      <Suspense fallback={<div className="text-sm text-zinc-600 italic">Loading Control Validator...</div>}>

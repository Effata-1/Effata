...
INSERT INTO genai_apps (app_id, app_name, vendor, domain, app_type, logo_letter, logo_bg, status, app_group, last_updated) VALUES
  ...
  ('cursor',             'Cursor',                   'Anysphere',        'cursor.com',                 'Code Assistant',       'C', '#1c1c1c', 'active', 'AI Coding Assistants',               '2026-05-01'),
  ('codeium',            'Codeium',                  'Codeium',          'codeium.com',                'Code Assistant',       'C', '#09b6a2', 'active', 'AI Coding Assistants',               '2026-05-01'),
  ('tabnine',            'Tabnine',                  'Tabnine',          'tabnine.com',                'Code Assistant',       'T', '#7c3aed', 'active', 'AI Coding Assistants',               '2026-05-01'),
  ('replit-ai',          'Replit AI',                'Replit',           'replit.com',                 'Code Assistant',       'R', '#f26207', 'active', 'AI Coding Assistants',               '2026-05-01'),
  ('amazon-q',           'Amazon Q',                 'Amazon Web Services', 'aws.amazon.com/q',        'AI Assistant',         'A', '#ff9900', 'active', 'AI Chatbots',                        '2026-05-01'),
  ('cohere',             'Cohere',                   'Cohere Inc.',      'coral.cohere.com',            'AI Assistant',         'C', '#39594d', 'active', 'AI Model Platforms & APIs',          '2026-05-01'),
  ('databricks-ai',      'Databricks AI',            'Databricks',       'databricks.com',             'AI Analytics',         'D', '#ff3621', 'active', 'AI Data Analysis',                   '2026-05-01'),
  ('glean',              'Glean',                    'Glean Technologies', 'glean.com',                'AI Search',            'G', '#1c64f2', 'active', 'AI Search & Knowledge',              '2026-05-01'),
  ('copy-ai',            'Copy.ai',                  'Copy.ai',          'copy.ai',                    'AI Writing',           'C', '#7c3aed', 'active', 'AI Document Tools',                  '2026-05-01'),
  ('jasper',             'Jasper',                   'Jasper AI',        'jasper.ai',                  'AI Writing',           'J', '#ff8c42', 'active', 'AI Document Tools',                  '2026-05-01'),
  ('writer',             'Writer',                   'Writer Inc.',      'writer.com',                 'AI Writing',           'W', '#2563eb', 'active', 'AI Document Tools',                  '2026-05-01'),
  ('elevenlabs',         'ElevenLabs',               'ElevenLabs',       'elevenlabs.io',              'AI Communication',     'E', '#1a1a2e', 'active', 'AI Creative & Design',               '2026-05-01'),
  ('otter-ai',           'Otter.ai',                 'Otter.ai',         'otter.ai',                   'AI Communication',     'O', '#0ea5e9', 'active', 'AI Meeting & Transcription',         '2026-05-01'),
  ('fireflies-ai',       'Fireflies.ai',             'Fireflies.ai',     'fireflies.ai',               'AI Communication',     'F', '#6366f1', 'active', 'AI Meeting & Transcription',         '2026-05-01'),
  ('adobe-firefly',      'Adobe Firefly',            'Adobe',            'firefly.adobe.com',          'Image Generator',      'A', '#fa0f00', 'active', 'AI Creative & Design',               '2026-05-01'),
  ('canva-ai',           'Canva AI',                 'Canva',            'canva.com',                  'AI Productivity',      'C', '#00c4cc', 'active', 'AI Creative & Design',               '2026-05-01'),
  ('gong',               'Gong AI',                  'Gong.io',          'gong.io',                    'AI Analytics',         'G', '#f97316', 'active', 'AI Sales & CRM',                     '2026-05-01'),
  ('zendesk-ai',         'Zendesk AI',               'Zendesk',          'zendesk.com',                'AI Communication',     'Z', '#03363d', 'active', 'AI Customer Support',                '2026-05-01'),
  ('you-com',            'You.com',                  'You.com',          'you.com',                    'AI Search',            'Y', '#2563eb', 'active', 'AI Search & Knowledge',              '2026-05-01'),
  ('loom-ai',            'Loom AI',                  'Loom (Atlassian)', 'loom.com',                   'AI Communication',     'L', '#625df5', 'active', 'AI Meeting & Transcription',         '2026-05-01')
